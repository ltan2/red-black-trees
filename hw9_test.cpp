...
TEST(BasicListTest, RemoveRebalanceChecksRightCases) {
  ...
  ASSERT_EQ(2, c2.height());
  ASSERT_EQ(true, c2.valid_rbt());
  // case 1: left child not along path
  RBTCollection<string,int> c3;
  c3.add("c", 30);
  c3.add("b", 20);
  c3.add("e", 50);
...
//
//----------------------------------------------------------------------
//Add in ascending and descending order
TEST(BasicListTest, AddAscendingandDescending) {
 // increasing order
  RBTCollection<string,int> c1;
  c1.add("a", 10);
  c1.add("b", 20);
...
//remove in ascending and descending
TEST(BasicListTest, RemoveInAscendingAndDescending) {
RBTCollection<string,int> c1;
  c1.add("a", 10);
  c1.add("b", 20);
  c1.add("c", 30);
...
TEST(BasicListTest, RemoveAtEmptyFront) {
RBTCollection<string,int> c1;
//empty
c1.remove("a");
c1.add("b",10);
